...
export default function ProfilePage() {
  ...
  return (
    <section className="min-h-screen px-10 pt-32 pb-20 md:px-2 lg:px-20">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-3">
              <Link href="/#scientists" className="w-fit bg-black px-4 py-2 text-sm text-white rounded-md">
                Explore Scientists
              </Link>
              <Link href="/#quizzes" className="w-fit bg-black px-4 py-2 text-sm text-white rounded-md">
                Take Quizzes
              </Link>
              <button
                type="button"
                onClick={handleLogout}
                className="w-fit border border-gray-900 px-4 py-2 text-sm rounded-md hover:bg-gray-100"
              >
                Log out
              </button>
            </div>
